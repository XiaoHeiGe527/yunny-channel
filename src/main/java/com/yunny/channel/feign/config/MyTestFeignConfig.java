...
@Configuration
public class MyTestFeignConfig {


    /**
     * 设置 MyTestFeignClient 超时时间
     * @return
     * @throws InterruptedException
     */
    @Bean
    public MyTestFeignClient myTestFeignClient() throws InterruptedException {
        return Feign.builder().
                ...
                .target(Target.EmptyTarget.create(MyTestFeignClient.class));
